            ...
            <div class="container">
                ...
                <form action="mailsubmit.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="form" class="form-control" id="exampleFormControlInput1" placeholder="From">
                    </div>
                    ...
                    <br />
                    <textarea cols="50" name="textarea" rows="5" name="message" class="form-control" placeholder="Enter your message">
</textarea>
<br />
